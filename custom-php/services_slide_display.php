<?php
function render_services_slide_display( $attribute )
{
...
//        "order"          => "DESC"
    ...
    $html .= '<div id="shortcode-portfolio-slide">';
...
$script = '
        ...
        jQuery(document).ready(function() {
            ...
            var owl = $("#shortcode-portfolio-slide");
            owl.owlCarousel({
                    loop:true,
                    margin:10,
                    nav:true,
...
add_shortcode( "services_slide_display" ,"render_services_slide_display");
?>