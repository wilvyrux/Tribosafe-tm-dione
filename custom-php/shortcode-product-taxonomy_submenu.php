...
add_shortcode('sc_product_taxonomy_submenu', 'render_sc_product_taxonomy3');
function render_sc_product_taxonomy3($atts){
    ...
    if (!is_wp_error($terms) && !empty($terms)) {
        ...
        $html .= '<div class="container custom-submenu">';
...
//            CURRENT ACTIVE 
            ...
            $html .= '    
                         ...
                         <div class="'. ( $is_current_term ? 'current-menu-item':'') .' col-md-3">
                                
                                <h4><span class="mini-cat-image">'. $img_cat .'</span> <a href="'. $term_link .'">' . $term_name .'</a></h4>
                                '. $term_products .'    
