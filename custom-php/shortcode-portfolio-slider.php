<?php
function render_shortcode_portfolio_slider( $attribute )
{
...
//    get the taxonomy name 
    ...
    $html .= '<div id="portfolio-wrapper">';
    
    //$html .= '<h2> Related Services</h2>';

    if ($loop->have_posts()) {
        
    $html .= '<div class="slider-portfolio">';
...
add_shortcode( "portfolio_slider" ,"render_shortcode_portfolio_slider");
?>