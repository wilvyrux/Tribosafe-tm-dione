...
function render_sc_product_taxonomy($atts){
    ...
    $html = '';
    $html .= '<div id="shortcode-ourproduct" class="product-slider">';

    if (!is_wp_error($terms) && !empty($terms)) {

        $html .= '<ul class="shortcode-product">';
...
//            FOR TERM PRODUCTS
            ...
            $html .= '    
                         ...
                         <li>
                                <div class="ourproduct-wrapper">
                                     <div class="featured-image"> '. $img_cat .' </div>
                                    <a href="'. $term_link .'" class="heading-slide">' . $term_name . '</a>
                                </div>
                        </li>
