<?php
function render_shortcode_ourpartners_slider( $attribute )
{
...
//        "order"          => "DESC"
    ...
    $html .= '<div id="shortcode-ourpartner">';
...
add_shortcode( "ourpartners_slider" ,"render_shortcode_ourpartners_slider");
?>