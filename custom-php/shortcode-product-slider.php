<?php
function render_shortcode_products( $attribute )
{
...
//        "order"          => "DESC"
    ...
    $html .= '<div class="product-main-wrapper">';
                        ...
                        <div>
                            <div class="">
                                ...
                                <div class="product_details">
                                     <h1>' . $post_title . '</h1>
                                     <p id="text">' . $post_shortcontent  . '</p>
                                     <a href="'. $post_object_link .'" class="readmore_btn"> Learn More </a>
                                </div>
...
add_shortcode( "product_slider" ,"render_shortcode_products");
?>